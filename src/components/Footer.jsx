...
const Footer = () => {
  return <footer className="bg-transparent border-t border-[rgba(16,185,129,0.22)] pt-16 pb-8">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="flex space-x-4">
            <a href="#" className="text-[rgba(248,250,252,0.72)] hover:text-[#34D399] transition-colors">
        ...
        {/* Product links */}
        <div>
          <h3 className="text-lg font-semibold mb-4 text-[#F8FAFC]">Product</h3>
        ...
        {/* Company links */}
        <div>
          <h3 className="text-lg font-semibold mb-4 text-[#F8FAFC]">Company</h3>
          <ul className="space-y-3">
            <li>
              <a href="#" className="text-[rgba(248,250,252,0.72)] hover:text-[#34D399] transition-colors">
                Blog
        ...
        {/* Legal links */}
        <div>
          <h3 className="text-lg font-semibold mb-4 text-[#F8FAFC]">Legal</h3>
          <ul className="space-y-3">
            <li>
              <a href="#" className="text-[rgba(248,250,252,0.72)] hover:text-[#34D399] transition-colors">
                Privacy Policy
      ...
      {/* Copyright */}
      <div className="mt-12 pt-8 border-t border-[rgba(16,185,129,0.22)] text-center text-sm text-[rgba(248,250,252,0.5)]">
